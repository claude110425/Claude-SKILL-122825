...
2. [Understanding the SKILL.md](#understanding-the-skillmd)
3. [Platform-Specific Instructions](#platform-specific-instructions)
4. [5 Detailed Step-by-Step Examples](#5-detailed-step-by-step-examples)
...
1. Analyze code or application descriptions
2. Generate comprehensive technical specifications
3. Structure the output in a format OPAL can understand
4. Include all necessary details for complete application generation
...
3. **Basic Workflow**
   ```
   Step 1: Paste SKILL.md into Claude
...
3. **Best Practices**
   ```
   - Use Custom Instructions feature to store SKILL.md
...
```markdown
# Todo List Application Description
...
3. You should see an empty conversation
...
```
You will be analyzing code or technical specifications and generating comprehensive instructions...
```
...
```
Now, please generate a comprehensive technical specification for the following application:
...
3. Paste the entire SKILL.md document
...
```
Now please generate a comprehensive technical specification for this application:
...
1. Copy everything between `<specification>` tags
2. Save as `recipe_app_specification.md`
...
1. Login to OPAL platform
2. Click "New Project"
3. Upload `recipe_app_specification.md`
...
```
I have a complete technical specification for a full-stack recipe manager application.
...
```
Looking at section 5.2.3 (RecipeForm component), please update it to:
...
### style.css
```css
[PASTE YOUR style.css CODE]
```

### app.js
```javascript
[PASTE YOUR app.js CODE]
```

## Desired Improvements
I want to expand this application with:
1. 5-day forecast display
2. Geolocation to get current location weather
3. Save favorite cities (localStorage)
4. Display weather icons
5. More detailed weather information (wind speed, pressure, etc.)
6. Better error handling
7. Loading states
8. Responsive design improvements
9. Dark mode toggle
10. Unit conversion (Celsius/Fahrenheit)
```
...
2. Geolocation for current position
3. Favorite cities management (localStorage)
4. Weather condition icons
5. Extended weather details (wind, pressure, UV index)
6. Loading and error states
7. Responsive design (mobile-first)
8. Dark/light theme toggle
9. Temperature unit conversion (°C/°F)
10. Recent searches history
</app_description>
...
1. Documents the existing code structure
2. Expands it with the new features
3. Maintains backward compatibility
4. Provides clear migration path
5. Includes all data models, components, and services needed
```
...
1. Save as `enhanced_weather_app_specification.md`
2. You now have a complete blueprint to:
...
```
Please generate the complete code for this enhanced weather application based on the specification.
...
```
Please generate a comprehensive technical specification for a React Native mobile application.
